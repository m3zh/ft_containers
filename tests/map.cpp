...
void	test_map(void)
{
	...
	test_it(map::ft_iterators, map::std_iterators, "iterators");
	test_it(map::ft_empty, map::std_empty, "empty and size"); // capacity
	test_it(map::ft_access, map::std_access, "element access");
	test_it(map::ft_insert, map::std_insert, "insert"); // modifiers
	test_it(map::ft_erase, map::std_erase, "erase"); // modifiers
	test_it(map::ft_swap, map::std_swap, "swap"); // modifiers
	test_it(map::ft_clear, map::std_clear, "clear"); // modifiers
	test_it(map::ft_keycomp, map::std_keycomp, "key_comp"); // observers
	test_it(map::ft_valuecomp, map::std_valuecomp, "value_comp"); // observers
	test_it(map::ft_find, map::std_find, "find"); // operations
	test_it(map::ft_count, map::std_count, "count"); // operations
